/*
 ...
 Source Schema         : db_2022_cloud

 Target Server Type    : MySQL
 Target Server Version : 80029
 File Encoding         : 65001

 Date: 15/08/2022 08:54:31
*/
...
CREATE TABLE `sys_menu`  (
  ...
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '0' COMMENT '菜单状态（0正常，1禁用）',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '角色菜单表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_user`  (
  ...
  `user_type` int(0) NULL DEFAULT NULL COMMENT '默认0-admin',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'root', 'admin', '$2a$10$aOKpgs5FXtaTIhR6rs/.TOVungtvJe31HUgLBMRGslFyZ0T91Awe2', '0', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 0);
